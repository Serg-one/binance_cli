...
class Binance:
    methods = {
        ...
        # futures
        'futuresPing': {'url': 'fapi/v1/ping', 'method': 'GET', 'private': False, 'futures': True},
        'futuresTime': {'url': 'fapi/v1/time', 'method': 'GET', 'private': False, 'futures': True},
        ...
        'futuresAccountTradeList': {'url': 'fapi/v1/userTrades', 'method': 'GET', 'private': True, 'futures': True}
    }
